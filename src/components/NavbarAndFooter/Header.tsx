    ...
    <div className="flex justify-between items-center mb-6 lg:mb-8 px-3 py-2 text-white fixed right-0 left-[250px] border-b z-10 bg-gray-900">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          {subtitle && <p className="text-gray-400 mt-1 text-sm lg:text-base">{subtitle}</p>}
        </div>
      </div>

      <div className="flex items-center gap-2 lg:gap-4">
        <Badge variant="outline" className="bg-red-500/10 text-red-400 border-red-500/20 hidden sm:inline-flex">
          Inactive Account
        </Badge>
